          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:contact.weboraagency@gmail.com" className="hover:text-blue-400 transition-colors">
            ...
            <div className="mt-4 flex space-x-4">
              <a href="https://www.instagram.com/Webora.be/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-600 transition-colors">
